...
InsertEmotionMsgListTable(ET_SMILE, "/ÇÏÇÏ")
...
InsertEmotionMsgListTable(ET_BEST, "/¿øÃò")
InsertEmotionMsgListTable(ET_BEST, "/¤º")
...
InsertEmotionMsgListTable(ET_HELP, "/¤º¤º")
...
InsertEmotionMsgListTable(ET_KIK, "/Å±")
InsertEmotionMsgListTable(ET_KIK, "/¤»")
InsertEmotionMsgListTable(ET_KIK, "/ÄÉÄÉ")
...
InsertEmotionMsgListTable(ET_OK, "/²ô´ö")
...
InsertEmotionMsgListTable(ET_SHY, "/ºÎ")
...
InsertEmotionMsgListTable(ET_CONGRATULATION, "/¤º¤»")
...
InsertEmotionMsgListTable(ET_HPTIME, "/ÇÇ")
...
InsertEmotionMsgListTable(ET_OHNO, "/ÇÑ¼û")
...
InsertEmotionMsgListTable(ET_ROCK, "/¹ÙÀ§")
...
InsertEmotionMsgListTable(ET_HUM2, "/Èì")
...
InsertEmotionMsgListTable(ET_ABS, "/¸Û")
...
InsertEmotionMsgListTable(ET_OOPS, "/¿ó")
...
InsertEmotionMsgListTable(ET_SPIT, "/À¡")
...
InsertEmotionMsgListTable(ET_ENE, "/Å»·Â")
...
InsertEmotionMsgListTable(ET_PANIC, "/°øÈ²")
