...
StateIconImgList = {
	[PRIORITY_GOLD] = {
		...
		[EFST_IDs.EFST_ESSENCE_OF_TIME] = "eldicastes.tga"
	},
	[PRIORITY_RED] = {
	...
	[PRIORITY_BLUE] = {
		...
		[EFST_IDs.EFST_MTF_MARIONETTE] = "helloween.TGA",
		[EFST_IDs.EFST_MTF_LUDE] = "helloween.TGA",
		[EFST_IDs.EFST_MTF_CRUISER] = "helloween.TGA",
		...
		[EFST_IDs.EFST_BLAZE_BEAD] = "gogi.tga",
		[EFST_IDs.EFST_FROZEN_BEAD] = "gogi.tga",
		[EFST_IDs.EFST_BREEZE_BEAD] = "gogi.tga",
		...
		[EFST_IDs.EFST_GLORY_OF_RETURN] = "efst_atk.TGA",
		...
		[EFST_IDs.EFST_ULTIMATECOOK] = "신의뜻.TGA",
		[EFST_IDs.EFST_MANA_PLUS] = "icon08.tga",
		[EFST_IDs.EFST_FULL_SWING_K] = "icon08.tga",
		[EFST_IDs.EFST_HUNTING_EVENT] = "gogi.tga",
		[EFST_IDs.EFST_TW_NEWYEAR_EVENT] = "item.tga",
		[EFST_IDs.EFST_FESTIVE_ENERGY] = "UNLIMIT.TGA",
		...
		[EFST_IDs.EFST_FLOWER_LEAF2] = "FLOWER_LEAF.TGA",
		[EFST_IDs.EFST_FLOWER_LEAF3] = "OFFERTORIUM.TGA",
		[EFST_IDs.EFST_FLOWER_LEAF4] = "PLUSATTACKPOWER.TGA",
	...
	[PRIORITY_WHITE] = {
		...
		[EFST_IDs.EFST_OVERSEA_BUFF_12] = "플래티넘알터.TGA",
		...
		[EFST_IDs.EFST_EXCLUSIVE_RECEIVEITEM] = "ITEM_G.TGA",
		[EFST_IDs.EFST_EXCLUSIVE_PLUSEXP] = "EXP_G.TGA",
